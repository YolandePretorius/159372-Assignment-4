...
A = Variable('A', {1,2,3,4}, position=(0,0.25))
B = Variable('B', {1,2,3,4}, position=(0.5,0))
C = Variable('C', {1,2,3,4}, position=(1,0.25))
C0 = Constraint([A,B], lt, "A < B", position=(0.25,0.8))
C1 = Constraint([B], ne_(2), "B != 2", position=(0.5,0.8))
C2 = Constraint([B,C], lt, "B < C", position=(0.75,0.8))
csp1 = CSP("csp1", {A, B, C},
           [C0, C1, C2])

D = Variable('D', {1,2,3,4}, position=(0.7,0.9))
E = Variable('E', {1,2,3,4}, position=(0.3,0.9))
...
# pij is the variable represeting the letter i from the left and j down (starting from 0)
p00 = Variable('p00',  letters, position=(0,0))
p10 = Variable('p10',  letters, position=(0,0))
p20 = Variable('p20',  letters, position=(0,0))
p01 = Variable('p01',  letters, position=(0,0))
p21 = Variable('p21',  letters, position=(0,0))
p02 = Variable('p02',  letters, position=(0,0))
p12 = Variable('p12',  letters, position=(0,0))
p22 = Variable('p22',  letters, position=(0,0))
p32 = Variable('p32',  letters, position=(0,0))
p03 = Variable('p03',  letters, position=(0,0))
p23 = Variable('p23',  letters, position=(0,0))
p24 = Variable('p24',  letters, position=(0,0))
p34 = Variable('p34',  letters, position=(0,0))
p44 = Variable('p44',  letters, position=(0,0))
p25 = Variable('p25',  letters, position=(0,0))
