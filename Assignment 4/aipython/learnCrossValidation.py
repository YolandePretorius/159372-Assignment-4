...
from learnProblem import Data_set, Data_from_file, squared_error, absolute_error, log_loss
...
def plot_error(data, criterion=squared_error, num_folds=5,  xscale='linear'):
    ...
    plt.plot(range(1,len(data.train)+2), terrors, ls='--',color='k',
