...
Bad_Experience = Variable("Bad_Experience", boolean, position=(0.1,0.5))
...
p_be = Prob(Bad_Experience, [Takes_Marijuana], [[1, 0], [0.4, 0.6]])
p_thd = Prob(Takes_Hard_Drugs, [Bad_Experience, Drug_Prone],
                 # Drug_Prone=False    Drug_Prone=True
                 [[[0.999, 0.001],     [0.6, 0.4]], # Bad_Experience=False
                  [[0.99999, 0.00001], [0.995, 0.005]]])  # Bad_Experience=True

drugs = BeliefNetwork("Gateway Drugs",
                    [Drug_Prone,Takes_Marijuana,Bad_Experience,Takes_Hard_Drugs],
